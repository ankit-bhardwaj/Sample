...
+ (UIImage *)imageWithColor:(UIColor *)color andSize:(CGSize)size {
    ...
    UIImage* rounded = [retval roundedCornerImage:5.0 borderSize:1.0];
...
- (UIImage *)resetOrientation
{
    ...
    switch ((int)self.imageOrientation) {
        case (int)UIImageOrientationDown:           // EXIF = 3
        case (int)UIImageOrientationDownMirrored:   // EXIF = 4
            newRect = CGRectMake(0, 0, self.size.width, self.size.height);
            break;
            
        case (int)UIImageOrientationLeft:           // EXIF = 6
        case (int)UIImageOrientationLeftMirrored:   // EXIF = 5
            newRect = CGRectMake(0, 0, self.size.height, self.size.width);
            break;
            
        case (int)UIImageOrientationRight:          // EXIF = 8
        case (int)UIImageOrientationRightMirrored:  // EXIF = 7
            newRect = CGRectMake(0, 0, self.size.height, self.size.width);
            break;
    }
...
- (CGAffineTransform)transformForOrientation:(CGSize)newSize {
    ...
    switch ((int)self.imageOrientation) {
        case (int)UIImageOrientationUpMirrored:     // EXIF = 2
        case (int)UIImageOrientationDownMirrored:   // EXIF = 4
            transform = CGAffineTransformTranslate(transform, newSize.width, 0);
