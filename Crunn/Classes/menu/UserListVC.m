...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    TaskUser* user = [self.userList objectAtIndex:indexPath.row];
    if([user isKindOfClass:[TaskUser class]])
        [(TaskUserCell*)cell fillDataForUser:user];
    else
    {
        [(TaskUserCell*)cell fillMeetingParticipationList:(MeetingParticipant*)user];
    }
